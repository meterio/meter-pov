...
func (rt *Runtime) EnforceTeslaFork12_Corrections(stateDB *statedb.StateDB, blockNum *big.Int, evm *vm.EVM) {
	blockNumber := rt.Context().Number
...
func (rt *Runtime) PrepareClause(
	...
	exec = func() (*Output, bool) {
		...
		// tesla fork12
		rt.EnforceTeslaFork12_Corrections(stateDB, evm.BlockNumber, evm)
