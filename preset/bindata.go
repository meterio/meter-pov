...
func shoalDelegatesJson() (*asset, error) {
	...
	info := bindataFileInfo{name: "shoal/delegates.json", size: 1165, mode: os.FileMode(0644), modTime: time.Unix(1722448288, 0)}
...
func mainnetDelegatesJson() (*asset, error) {
	...
	info := bindataFileInfo{name: "mainnet/delegates.json", size: 1950, mode: os.FileMode(0644), modTime: time.Unix(1722448288, 0)}
