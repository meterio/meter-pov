...
contract Prototype {
    ...
    function balance(address _self, uint256 _blockNumber)
        public
        view
        returns (uint256)
    {
        return
            PrototypeNative(this).native_balanceAtBlock(
                _self,
                uint32(_blockNumber)
            );
    }

    function energy(address _self, uint256 _blockNumber)
        public
        view
        returns (uint256)
    {
        return
            PrototypeNative(this).native_energyAtBlock(
                _self,
                uint32(_blockNumber)
            );
    }
    ...
    function creditPlan(address _self)
        public
        view
    ...
    function setCreditPlan(
        ...
        onlySelfOrMaster(_self);
        PrototypeNative(this).native_setCreditPlan(
            _self,
            _credit,
            _recoveryRate
        );
    ...
    function userCredit(address _self, address _user)
        public
        view
        returns (uint256)
    {
    ...
    function addUser(address _self, address _user) public {
        ...
        onlySelfOrMaster(_self);
        require(
            PrototypeNative(this).native_addUser(_self, _user),
    ...
    function removeUser(address _self, address _user) public {
        onlySelfOrMaster(_self);
        require(
            PrototypeNative(this).native_removeUser(_self, _user),
            "builtin: not a user"
        );
    }
    ...
    function isSponsor(address _self, address _sponsor)
        public
        view
        returns (bool)
    {
    ...
    function selectSponsor(address _self, address _sponsor) public {
        onlySelfOrMaster(_self);
        require(
            PrototypeNative(this).native_selectSponsor(_self, _sponsor),
            "builtin: not a sponsor"
        );
    }
    ...
    function onlySelfOrMaster(address _self) internal view {
        require(
            _self == msg.sender ||
                PrototypeNative(this).native_master(_self) == msg.sender,
...
contract PrototypeNative {
    ...
    function native_balanceAtBlock(address self, uint32 blockNumber)
        public
        view
        returns (uint256);

    function native_energyAtBlock(address self, uint32 blockNumber)
        public
        view
        returns (uint256);
    ...
    function native_storageFor(address self, bytes32 key)
        public
        view
        returns (bytes32);

    function native_creditPlan(address self)
        public
        view
        returns (uint256, uint256);

    function native_setCreditPlan(
        address self,
        uint256 credit,
        uint256 recoveryRate
    ) public;

    function native_isUser(address self, address user)
        public
        view
        returns (bool);

    function native_userCredit(address self, address user)
        public
        view
        returns (uint256);
    ...
    function native_removeUser(address self, address user)
        public
        returns (bool);

    function native_sponsor(address self, address sponsor)
        public
        returns (bool);

    function native_unsponsor(address self, address sponsor)
        public
        returns (bool);

    function native_isSponsor(address self, address sponsor)
        public
        view
        returns (bool);

    function native_selectSponsor(address self, address sponsor)
        public
        returns (bool);
